...
import { render as vincleRender } from "@vincle/core";

export function render(name: string, purchases: Purchase[]): string {
  return vincleRender(RealWorldPage(name, purchases)) as string;
}
