  ...
  return (
    <div class="docs-home">
      ...
      <div class="mb-24 flex flex-wrap items-center gap-4">
        ...
        <a
          href="https://github.com/cjean-fr/vincle"
      ...
      <div class="mb-20">
        ...
        <CodeExample src="home/hello.tsx" output />
        <div class="mt-4">
      ...
      <div class="mb-20 grid grid-cols-1 gap-5 sm:grid-cols-2">
        <FeatureCard
          ...
          description="No opt-in needed: all content HTML-escaped, dangerous URL schemes blocked, function-valued attributes rejected."
        />
        <FeatureCard
          icon={<BoltIcon />}
          title="Async-native"
      ...
      <div class="mb-6 flex flex-wrap gap-3 border-t border-[var(--docs-color-border)] pt-8">
        <a href="https://github.com/cjean-fr/vincle/actions/workflows/ci.yml">
          <img
            src="https://github.com/cjean-fr/vincle/actions/workflows/ci.yml/badge.svg"
            alt="CI"
            height="20"
          />
        </a>
